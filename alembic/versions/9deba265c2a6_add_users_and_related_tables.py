"""add users and related tables

Revision ID: 9deba265c2a6
Revises:
Create Date: 2026-09-18 15:40:28.176061
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_user_sessions_session_id_hash"),
        "user_sessions",
        ["session_id_hash"],
        unique=True,
    )
